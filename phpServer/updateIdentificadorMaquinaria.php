...
require_once '../modelo/dao/MaquinariaDao.php'; // Asegúrate de cargar el DAO correctamente
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    $nombreTablaMaquinaria = $data['nombreTablaMaquinaria'] ?? '';
    $checkFactoresMaquinaria = $data['checkFactoresMaquinaria'] ?? '';
    ...
    $success = $dao->updateIdentificadorMaquinaria(
        $nombreTablaMaquinaria,
        $checkFactoresMaquinaria,
        $totalKamati,
        $totalCliente,
        $idIdentificadorMaquinaria
    );
