...
if (isset($data['id_factoresAdicionalesMaquinaria']) && isset($data['factors'])) {
    $id = $data['id_factoresAdicionalesMaquinaria'];
    $factors = $data['factors'];

    $factorDao = new FactorIndependienteMaquinariaDao();
    $result = $factorDao->registrarFactoresAdicionalesMaquinaria($id, $factors);
