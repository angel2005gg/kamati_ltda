                ...
                try {
                    ...
                    foreach ($campos as $campo) {
                        if (!isset($_POST[$campo]) || empty($_POST[$campo])) {
                            header("Location: ../vista/registroUsuario.php?tipo=danger&mensaje=" . urlencode('Uno de los campos esta  vacío.'));
                            exit;
                        }
                    }
                    ...
                    if (
                        ...
                        switch ($_POST['txt_rolUsuario']) {
                            case 1:
                                ...
                                header("Location: ../vista/registroUsuario.php?tipo=success&mensaje=" . urlencode('Se ha registrado exitosamente.'));
                                exit;
                                break;
                            ...
                            case 3:
                                $controladorUser->controlRegistrarUsuario($usuario);
                                header("Location: ../vista/registroUsuario.php?tipo=successr&mensaje=" . urlencode('Se ha registrado exitosamente.'));
                                exit;
                                break;
                        ...
                        header("Location: ../vista/registroUsuario.php?tipo=danger&mensaje=" . urlencode('No se ha podido registrar.'));
                        exit;
                    }
                } catch (Exception $e) {
