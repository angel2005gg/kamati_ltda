                ...
                try {
                    ...
                    foreach ($campos as $campo) {
                        if (!isset($_POST[$campo]) || empty($_POST[$campo])) {
                            header("Location: ../vista/registroUsuarioJefeAdminL.php?tipo=danger&mensaje=" . urlencode('Registro fallido.'));
                            exit;
                        }
                    }
                    ...
                    if (
                        ...
                        if ($_POST['txt_contrasena'] !== $_POST['txt_verificarContrasena']) {
                            header("Location: ../vista/registroUsuarioJefeAdminL.php?tipo=danger&mensaje=" . urlencode('Las contraseñas no coinciden .'));
                            exit;
                        }
                        ...
                        if ($usuario != null) {
                            ...
                            header("Location: ../vista/registroUsuarioJefeAdminL.php?tipo=danger&mensaje=" . urlencode('No se pudo reailizar el resgitro del usuario.'));
                            exit;
                        }
                    } else {
                        header("Location: ../vista/registroUsuarioJefeAdminL.php?tipo=danger&mensaje=" . urlencode('Uno de los campos esta vacío.'));
                        exit;
                    }
                } catch (Exception $e) {
