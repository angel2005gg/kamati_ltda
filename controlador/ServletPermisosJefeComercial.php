...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($menu === "solicitar") {
        switch ($accion) {
            ...
            case "Regresar":
                header('Location: ../vista/DashboardJefeComercial.php');
                exit;
                break;
                    ...
                    if (isset($_POST['radio1'])) {
                        ...
                        try {
                            ...
                            if ($_POST['radio1'] === 'Cumpleaños' || $_POST['radio1'] === 'DiaFamilia') {
                                ...
                                foreach ($campos as $campo) {
                                    if (!isset($_POST[$campo]) || empty($_POST[$campo])) {
                                        header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=success&mensaje=" . urlencode('Uno de los campos esta vacío.'));
                                        exit;
                                    }
                                }
                            ...
                            if ((DateTime::createFromFormat('Y-m-d', $_POST["txt_date_eleboracion1"]) !== false) && (DateTime::createFromFormat('Y-m-d', $_POST["date_inicio"]) !== false) && (DateTime::createFromFormat('Y-m-d', $_POST["date_fin"]) !== false)) {
                                ...
                                switch ($_POST['radio1']) {
                                    case 'Permiso':
                                        if ($permisos !== null) {
                                            ...
                                            header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=success&mensaje=" . urlencode('Solicitud enviada exitosamente.'));
                                            exit;
                                        } else {
                                            header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=danger&mensaje=" . urlencode('Solicitud fallida.'));
                                            exit;
                                        }
                                        break;
                                    case 'Licencia':
                                ...
                                header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=danger&mensaje=" . urlencode('Las fechas estan descordinadas.'));
                                exit;
                            }
                        } catch (Exception $e) {
                            header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=danger&mensaje=" . urlencode('Solicitud fallida.'));
                        ...
                        header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=danger&mensaje=" . urlencode('Primero selecciona un tipo de solicitud.'));
                        exit;
                    }
                } catch (Exception $e) {
                    header("Location: ../vista/solicitarPermisoJefeComercial.php?tipo=danger&mensaje=" . urlencode('Solicitud fallida.'));
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if (isset($_POST['select_remunerado'])) {
                        try {
                            ...
                            foreach ($campos as $campo) {
                                if (!isset($_POST[$campo]) || empty($_POST[$campo])) {
                                    header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('Uno de los campos esta vacío.'));
                                    exit;
                                }
                            }
                            ...
                            try {
                                if (isset($_POST['txt_hidden_estado']) && ($_POST['txt_hidden_estado'] === 'Pendiente' || $_POST['txt_hidden_estado'] === 'Negado' ||  $_POST['txt_hidden_estado'] === 'Aprobado' ||$_POST['txt_hidden_estado'] === 'No aprobado')) {
                                    header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('Esta solicitud ya se ha enviado a gestion humana.'));
                                    exit;
                                    ...
                                    if ($permisos1 !== null) {
                                        ...
                                        header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=success&mensaje=" . urlencode('Se ha aprobado la solicitud.'));
                                        exit;
                                    } else {
                                        header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('No de se ha aprobado la solicitud.'));
                                        exit;
                                    }
                                }
                            } catch (Exception $e) {
                                header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('No se ha podido aprobar la solicitud.'));
                                exit;
                            }
                        } catch (Exception $e) {
                            header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('No se ha podido aprobar la solicitud.'));
                        ...
                        header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('Primero selecciona la remuneración de la solicitud.'));
                        exit;
                    }
                } else {
                    header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('Método no válido.'));
                    exit;
                }
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if (isset($_POST['select_remunerado'])) {
                        ...
                        try {
                            ...
                            try {
                                if (isset($_POST['txt_hidden_estado']) && ($_POST['txt_hidden_estado'] === 'Pendiente' || $_POST['txt_hidden_estado'] === 'Negado' ||  $_POST['txt_hidden_estado'] === 'Aprobado' ||$_POST['txt_hidden_estado'] === 'No aprobado')) {
                                    header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('Ya se ha enviado esta solicitud a gestion humana.'));
                                    exit;
                                } else if (isset($_POST['txt_hidden_estado'])) {
                                    $permisos1 = new Permisos();
                                    $permisos1->setRemuneracion($_POST['select_remunerado']);
                                    ...
                                    if ($permisos1 !== null) {
                                        ...
                                        header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=success&mensaje=" . urlencode('Se ha negado la solicitud.'));
                                        exit;
                                    } else {
                                        header("Location: ../vista/consultaSolicitudesEnviadasJefeComercial.php?tipo=danger&mensaje=" . urlencode('No se ha podido, no aprobar la solicitud.'));
                                        exit;
                                    }
                                }
                            } catch (Exception $e) {
