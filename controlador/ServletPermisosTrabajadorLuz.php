...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($menu === "solicitar") {
        switch ($accion) {
            ...
            case "Regresar":
                header('Location: ../vista/DashboardTrabajadorLuz.php');
                exit;
                break;
            ...
            case "Enviar":
                ...
                if (isset($_POST['radio1'])) {
                        ...
                        if ($_POST['radio1'] === 'Cumpleaños' || $_POST['radio1'] === 'DiaFamilia') {
                            ...
                            foreach ($campos as $campo) {
                                if (!isset($_POST[$campo]) || empty($_POST[$campo])) {
                                    header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=danger&mensaje=" . urlencode('Uno de los campos esta vacío'));
                                    exit;
                                }
                            }
                            ...
                            switch ($_POST['radio1']) {
                                case 'Permiso':
                                    if ($permisos !== null) {
                                        ...
                                        header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=success&mensaje=" . urlencode('Se ha solicitado con exito.'));
                                        exit;
                                    } else {
                                        header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=danger&mensaje=" . urlencode('No se ha podido, no aprobar la solicitud'));
                                        exit;
                                    }
                                    break;
                                case 'Licencia':
                                ...
                                case 'Vacaciones':
                                    ...
                                    break;
                                default:
                                        header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=danger&mensaje=" . urlencode('Opción inválida'));
                                        exit;
                                    break;
                            }
                        } else {
                            header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=danger&mensaje=" . urlencode('Las fechas no estan cargando'));
                            exit;
                        }
                    } catch (Exception $e) {
                        header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=danger&mensaje=" . urlencode('No se ha podido, no aprobar la solicitud.'));
                    ...
                    header("Location: ../vista/solicitarPermisoTrabajadorLuz.php?tipo=danger&mensaje=" . urlencode('Primero selecciona el tipo de solicitud.'));
                    exit;
                }
                break;
