...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $emailJefe = $jefe->consultarJefeSinJson($_SESSION['id_user_jefe_permiso']);
    ...
    $recipientEmail3 =  $emailJefe->getCorreo_electronico();

   

    $message = "Estimado/a ".$_SESSION['nombre_persona_completo']. "<br><br>" .
    " Espero que se encuentre muy bien <br><br>".
    " Le escribe Kamati notificandole que su permiso - licencia - vacaciones ha sido aprobado. <br><br>". 
    " Por favor revisa la página en el apartado de 'solicitudes', para visualizar tu solicitud aprobada <br><br> ".
