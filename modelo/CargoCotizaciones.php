...
{
    private $id_CargoCotizacion, $id_CotizacionComercialfk, $nombre_cargo_cotizacion, $estado_cargo_cotizacion, $valor_dia;


    public function __construct(
        $id_CargoCotizacion = null,
        $id_CotizacionComercialfk = null,
        $nombre_cargo_cotizacion = null,
        $estado_cargo_cotizacion = null,
        $valor_dia = null
    ) {
        $this->id_CargoCotizacion = $id_CargoCotizacion;
        $this->id_CotizacionComercialfk = $id_CotizacionComercialfk;
    ...
    public function getId_CotizacionComercialfk()
    {
        return $this->id_CotizacionComercialfk;
    }

    public function setId_CotizacionComercialfk($id_CotizacionComercialfk)
    {
        $this->id_CotizacionComercialfk = $id_CotizacionComercialfk;
