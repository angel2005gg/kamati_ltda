                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_factor_mo1" id="txt_factor_mo1" placeholder="" value="${factorMo}">
                            <label for="segundoApellido">Factor Mo</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_factor_o1" id="txt_factor_o1" placeholder="" value="${factorO}">
                            <label for="numeroIdentificacion">Factor O</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_poliza1" id="txt_poliza1" placeholder="" value="${poliza}">
                            <label for="correoElectronico">Póliza</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_siemens1" id="txt_siemens1" placeholder="" value="${siemens}">
                            <label for="correoElectronico">Siemens</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_pilz1" id="txt_pilz1" placeholder="" value="${pilz}">
                            <label for="correoElectronico">Pilz</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_rittal1" id="txt_rittal1" placeholder="" value="${rittal}">
                            <label for="correoElectronico">Rittal</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_phoenix1" id="txt_phoenix1" placeholder="" value="${phoenix}">
