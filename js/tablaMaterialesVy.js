        ...
        divContenedor.innerHTML = `
            <div class="stacked-form tm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_poliza1" id="txt_poliza" placeholder="" value="${poliza}">
                            <label for="correoElectronico">Póliza</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_siemens1" id="txt_siemens" placeholder="" value="${siemens}">
                            <label for="correoElectronico">Siemens</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_pilz1" id="txt_pilz" placeholder="" value="${pilz}">
                            <label for="correoElectronico">Pilz</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_rittal1" id="txt_rittal" placeholder="" value="${rittal}">
                            <label for="correoElectronico">Rittal</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control limpiar" name="txt_phoenix1" id="txt_phoenix" placeholder="" value="${phoenix}">
