...
<nav class="navbar navbar-expand-lg navbar-light bg-custom">
    <div class="container-fluid color_fluid">
        <a class="navbar-brand" href="DashboardJefeCielo.php"><img src="../img/logo_transparent_kamati_cortada.png" alt="" class="img_logo_kamati"></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="solicitarPermisoJefeCielo.php">Solicitar novedad.</a></li>
                        <li><a class="dropdown-item" href="ConsultaSolicitudesJefeCielo.php">Consultar mis solicitudes</a></li>
                        <li><a class="dropdown-item" href="consultaSolicitudesEnviadasJefeCielo.php">Consultar solicitudes pendientes</a></li>
