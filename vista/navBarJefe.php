...
<nav class="navbar navbar-expand-lg navbar-light bg-custom">
    <div class="container-fluid color_fluid">
        <a class="navbar-brand" href="DashboardJefe.php"><img src="../img/logo_transparent_kamati_cortada.png" alt="" class="img_logo_kamati"></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="solicitarPermisoJefe.php">Solicitar novedad.</a></li>
                        <li><a class="dropdown-item" href="ConsultaSolicitudesJefe.php">Consultar mis solicitudes</a></li>
                        <li><a class="dropdown-item" href="consultaSolicitudesEnviadasJefe.php">Consultar solicitudes pendientes</a></li>
