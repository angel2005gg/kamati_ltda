...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-custom">
        <div class="container-fluid color_fluid">
            <a class="navbar-brand" href="DashboardJefeAdminL.php"><img src="../img/logo_transparent_kamati_cortada.png" alt="" class="img_logo_kamati"></a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="solicitarPermisoJefeAdminL.php">Solicitar novedad.</a></li>
                            <li><a class="dropdown-item" href="ConsultaSolicitudesJefeAdminL.php">Consultar mis solicitudes</a></li>
                            <li><a class="dropdown-item" href="consultaSolicitudesEnviadasJefeAdminL.php">Consultar solicitudes pendientes</a></li>
                            <li><a class="dropdown-item" href="consultaSolicitudesPendientesJefeAdminL.php">Consultar solicitudes aprobadas</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="registroUsuarioJefeAdminL.php">Registrar Usuarios</a></li>
                            <li><a class="dropdown-item" href="ConsultaUsuariosJefeAdminL.php">Consultar usuarios</a></li>
                            <li>
                                <hr class="dropdown-divider back_ground">
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="consultaCargosL.php">Consultar Cargos</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="variablesL.php">Consultar Variables</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="reporteSolicitudesL.php">Generar reporte de novedades</a></li>
