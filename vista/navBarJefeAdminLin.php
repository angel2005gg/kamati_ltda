...
<body>
    <nav class="navbar navbar-expand-lg navbar-lg bg-custom">

        <div class="container-fluid color_fluid">
            <a class="navbar-brand" href="DashboardJefeAdminLin.php"><img src="../img/logo_transparent_kamati_cortada.png" alt="" class="img_logo_kamati"></a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="solicitarPermisoJefeAdminLin.php">Solicitar novedad.</a></li>
                            <li><a class="dropdown-item" href="ConsultaSolicitudesJefeAdminLin.php">Consultar mis solicitudes</a></li>
                            <li><a class="dropdown-item" href="consultaSolicitudesPendientesJefeAdminLin.php">Consultar solicitudes aprobadas</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text_custom" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="registroUsuarioJefeAdminLin.php">Registrar Usuarios</a></li>
                            <li><a class="dropdown-item" href="ConsultaUsuariosJefeAdminLin.php">Consultar usuarios</a></li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="consultaCargosLin.php">Consultar Cargos</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="variablesLin.php">Consultar Variables</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="reporteSolicitudesLin.php">Generar reporte de novedades</a></li>
