...
<body>
    ...
    <div class="container">
        ...
        <div class="container_table">
            ...
            <form id="filter-form-pendientes">
                <div class="form-floating tma">
                    <input type="date" class="form-control" name="fechaEnviadasL" id="fechaEnviadasL" placeholder="" required>
            ...
            <div class="tabla_solicitudes">
                <table class="table-responsive">
                    ...
                    <tbody id="table_body_select" class="del_btn_select">
        ...
        <form method="POST" action="../controlador/ServletPermisosJefeAdminL.php">
                ...
                <div class="formulario_de_registro_usuario_intranet">
                    ...
                    <div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="hidden" class="form-control" name="txt_Remuneracion1" id="txt_Remuneracion1" value="1">
                        ...
                        <div class="row g-3 centro">
                            <input type="hidden" name="menu" value="permisos">
    ...
    <script src="../js/JavaScriptSeleccionarSolicituddd.js"></script>
