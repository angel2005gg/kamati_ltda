...
<body>
    ...
    <?php include 'navBarJefeAdmin.php';
    ...
    <div class="container_table">
        ...
        <form id="filter-form-pendientes">
            <div class="form-floating tma">
                <input type="date" class="form-control" name="fechaEnviadasJefeAdmin" id="fechaEnviadasJefeAdmin" placeholder="" required>
            ...
            <table class="table-responsive">
                <thead>
                    <tr class="tr_class">
                        ...
                        <th scope="col">Fecha&nbsp;fin&nbsp;novedad</th>
                ...
                <tbody id="table_body_select_adminJefe" class="del_btn_select">
    ...
    <form method="POST" action="../controlador/ServletPermisosJefeAdmin.php">
            ...
            <div class="formulario_de_registro_usuario_intranet">
                ...
                <div>
                    ...
                    <div class="row g-3 centro">
                        <input type="hidden" name="menu" value="permisosJefeAdmin">
    ...
    <script src="../js/JavaScriptSeleccionarSolicitudJefeAdminn.js"></script>
