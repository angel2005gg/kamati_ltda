...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-custom">
        <div class="container-fluid color_fluid">
            <a class="navbar-brand" href="DashboardAdmin.php"><img src="../img/logo_transparent_kamati_cortada.png" alt="" class="img_logo_kamati"></a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="solicitarPermiso.php">Solicitar novedad.</a></li>
                            <li><a class="dropdown-item" href="ConsultaSolicitudes.php">Consultar mis solicitudes.</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="ConsultaUsuarios.php">Consultar usuarios</a></li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="consultaCargosAdmin.php">Consultar Cargos</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="variablesAdmin.php">Consultar Variables</a></li>
    ...
    <!-- Luego incluir Popper.js -->
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.4/dist/umd/popper.min.js"></script>
    <!-- Luego incluir Bootstrap JS -->
